...
public class CampeonatoController {
    ...
    @PutMapping("/{campId}")
    public ResponseEntity<Campeonato> atualizar(@PathVariable Long campId, @RequestBody Campeonato camp) {
        Campeonato campAtual = campeonatoRepository.buscar(campId);

        BeanUtils.copyProperties(camp, campAtual);
        campeonatoRepository.salvar(campAtual);

        return ResponseEntity.ok(campAtual);
